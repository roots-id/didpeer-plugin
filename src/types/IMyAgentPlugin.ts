...
export interface IMyAgentPlugin extends IPluginMethodMap {
   ...
   */
  myDidPeer(args: IMyAgentDidPeerArgs, context: IRequiredContext): Promise<IMyAgentDidPeerResult>
}

/**
 * Arguments needed for {@link MyAgentPlugin.myDidPeer}
 * To be able to export a plugin schema, your plugin methods should use an `args` parameter of a
 * named type or interface.
 *
 * @beta
 */
export interface IMyAgentDidPeerArgs {
  /**
...
/**
 * Result of {@link MyAgentPlugin.myDidPeer}
